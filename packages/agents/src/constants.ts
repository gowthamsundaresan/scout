...
export const TEMPLATE_DIGEST_PING = 'digest-ping'

export const CEO_TASK_QUEUE = 'ceo'
export const CEO_WORKFLOW_ID = 'ceo-digest'
export const CEO_SCHEDULE_ID = 'ceo-digest-6h'

export const EVALS_CLIENT_ID = 'evals'
export const EVALS_TASK_QUEUE = 'evals'
